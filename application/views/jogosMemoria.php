...
<div class="header col-md-12">
    <h1 class="text-center"> Jogos para a Memoria de curto prazo</h1>
    <div class="col-md-12">
        ...
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <h4>
                    ...
                    <p><strong> Modo Facil</strong> - 6 pares</p>
        ...
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <h4>
                    ...
                    <p><strong> Modo Médio</strong> - 10 pares</p>
        ...
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <h4>
                    ...
                    <p><strong> Modo Dificil</strong> - 15 pares</p>
            ...
            <div class="modal-content">
                ...
                <div class="text-justify modal-body">
                    ...
                    <div style="margin-bottom: 80px">
                        <div class="col-xs-4"><h4>> Benefícios:</h4></div>
                        <div class="col-xs-4">
                            <h4>
                                <small>
